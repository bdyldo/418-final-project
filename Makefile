...
test_few: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) few

test_few_8: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) few_8

test_few_16: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) few_16

test_medium: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) medium

test_medium_16: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) medium_16

test_medium_32: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) medium_32

test_abundant: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) abundant

test_abundant_64: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) abundant_64

test_abundant_128: $(BENCHMARK_TARGET)
	./$(BENCHMARK_TARGET) abundant_128

svg_few: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) few $(BENCHMARK_SVG_DIR)

svg_few_8: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) few_8 $(BENCHMARK_SVG_DIR)

svg_few_16: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) few_16 $(BENCHMARK_SVG_DIR)

svg_medium: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) medium $(BENCHMARK_SVG_DIR)

svg_medium_16: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) medium_16 $(BENCHMARK_SVG_DIR)

svg_medium_32: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) medium_32 $(BENCHMARK_SVG_DIR)

svg_abundant: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) abundant $(BENCHMARK_SVG_DIR)

svg_abundant_64: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) abundant_64 $(BENCHMARK_SVG_DIR)

svg_abundant_128: $(BENCHMARK_TARGET)
	mkdir -p $(BENCHMARK_SVG_DIR)
	./$(BENCHMARK_TARGET) abundant_128 $(BENCHMARK_SVG_DIR)

clean:
	rm -f $(TARGET) $(TEST_TARGET) $(BENCHMARK_TARGET) $(BENCHMARK_CASE_TOOL_TARGET)
	rm -rf $(BENCHMARK_SVG_DIR)
